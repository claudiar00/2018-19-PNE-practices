...
ciudad = input("Please choose a city to know its weather: ")
...
conn.close()
meta_info = json.loads(raw_response)

if len(meta_info) == 0:
    print("The city you've chosen is not available or doesn't exist")
    sys.exit()

woeid = meta_info[0]['woeid']
